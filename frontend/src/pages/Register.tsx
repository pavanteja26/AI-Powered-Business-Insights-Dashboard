...
const Register: React.FC = () => {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    if (password.length < 6) {
      return setError('Please make sure your password is at least 6 characters long.');
    }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center gradient-bg font-sans p-4 relative overflow-hidden">
      <div className="absolute top-[-10%] right-[-10%] w-96 h-96 bg-purple-600 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-[128px] opacity-30 dark:opacity-40 animate-float"></div>
      <div className="absolute bottom-[-10%] left-[-10%] w-96 h-96 bg-blue-600 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-[128px] opacity-30 dark:opacity-40 animate-float" style={{ animationDelay: '2s' }}></div>
      ...
      <div className="w-full max-w-md glass-panel px-8 py-10 rounded-2xl relative z-10">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-slate-500 dark:text-slate-300 text-base">Get started for free</p>
        </div>
